...
class M170607075022Create_wallet_recharge_table extends Migration
{
    public function safeUp()
    {
        ...
        $this->createTable('{{%wallet_recharge}}', [
            'id' => $this->primaryKey(),
    ...
    {
        $this->dropTable('{{%wallet_recharge}}');
    }
    ...
    {
        echo "M170607075022Create_wallet_recharge_table cannot be reverted.\n";
